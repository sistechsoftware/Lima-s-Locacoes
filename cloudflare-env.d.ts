/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 023b13ffe7e727380e6c9149f97c9ec7)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	NOMINATIM_URL: "https://nominatim.openstreetmap.org/";
	OSRM_URL: "https://routing.openstreetmap.de/routed-car";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NOMINATIM_URL" | "OSRM_URL" | "VAPID_SUBJECT" | "VAPID_PUBLIC_KEY" | "VAPID_PRIVATE_KEY">> {}
}
